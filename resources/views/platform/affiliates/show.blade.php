...
<div class="row">
    <div class="col-lg-8 mb-3">
        ...
        <div class="card mb-3">
            <div class="card-header"><h5 class="mb-0">Referred schools</h5></div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="4" class="text-center text-muted p-3">No schools yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
        ...
        <div class="card">
            <div class="card-header"><h5 class="mb-0">Commission ledger</h5></div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        <thead>
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="4" class="text-center text-muted p-3">No ledger rows.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
    ...
    <div class="col-lg-4 mb-3">
        @if ($affiliate->photo_path)
            <div class="card mb-3">
                <div class="card-header"><h5 class="mb-0">Photo / KYC</h5></div>
