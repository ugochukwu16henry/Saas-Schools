    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(Qs::userIsTeamSA())
                <li class="nav-item">
                    <a href="{{ route('billing.status') }}" class="nav-link {{ Route::is('billing.status') ? 'active' : '' }}"><i class="icon-credit-card"></i> <span>Billing</span></a>
                </li>
                @endif

                @if(Qs::userIsTeamSA())
                <li class="nav-item">
                    <a href="{{ route('ai.announcement.page') }}" class="nav-link {{ Route::is('ai.announcement.page') ? 'active' : '' }}"><i class="icon-magic-wand"></i> <span>AI Drafts</span></a>
                </li>
                @endif
