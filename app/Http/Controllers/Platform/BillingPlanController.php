...
class BillingPlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'affiliate_one_time_commission_per_student' => ['required', 'integer', 'min:0', 'max:1000000'],
            'affiliate_monthly_commission_per_student' => ['required', 'integer', 'min:0', 'max:1000000'],
        ...
        DB::transaction(function () use ($data) {
            ...
            BillingPlan::create([
                ...
                'affiliate_one_time_commission_per_student' => (int) $data['affiliate_one_time_commission_per_student'],
                'affiliate_monthly_commission_per_student' => (int) $data['affiliate_monthly_commission_per_student'],
